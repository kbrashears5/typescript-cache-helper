...
const cacheHelperMockResolves = new CacheHelper(
...
beforeAll(() => {
  cacheHelperMockResolves.Initialize(
    TestValues.CacheNames,
    TestValues.CacheExpirationSeconds,
  );
...
describe(`${CacheHelper.name}.${cacheHelperMockResolves.Add.name}`, () => {
  ...
  test(`${TestValues.ThrowsOnEmpty} cacheName`, () => {
    const actual = () =>
      cacheHelperMockResolves.Add(
        TestValues.EmptyString,
        TestValues.Key,
        TestValues.Value,
      );
    return expect(actual).toThrow(
...
describe(`${CacheHelper.name}.${cacheHelperMockResolves.Delete.name}`, () => {
  ...
  test(`${TestValues.ThrowsOnEmpty} cacheName`, () => {
    const actual = () =>
      cacheHelperMockResolves.Delete(TestValues.EmptyString, TestValues.Key);
    return expect(actual).toThrow(
      `[${action}]-${TestValues.MustSupply} [cacheName]`,
    );
  });
  test(`${TestValues.ThrowsOnEmpty} key`, () => {
    const actual = () =>
      cacheHelperMockResolves.Delete(
        TestValues.CacheName,
        TestValues.EmptyString,
      );
    return expect(actual).toThrow(`[${action}]-${TestValues.MustSupply} [key]`);
...
describe(`${CacheHelper.name}.${cacheHelperMockResolves.FindCache.name}`, () => {
  ...
  test(`${TestValues.ThrowsOnEmpty} cacheName`, () => {
    const actual = () =>
      cacheHelperMockResolves.FindCache(TestValues.EmptyString);
    return expect(actual).toThrow(
      `[${action}]-${TestValues.MustSupply} [cacheName]`,
    );
  });
...
describe(`${CacheHelper.name}.${cacheHelperMockResolves.Get.name}`, () => {
  ...
  test(`${TestValues.ThrowsOnEmpty} cacheName`, () => {
    const actual = () =>
      cacheHelperMockResolves.Get(TestValues.EmptyString, TestValues.Key);
    return expect(actual).toThrow(
      `[${action}]-${TestValues.MustSupply} [cacheName]`,
    );
  });
...
describe(`${CacheHelper.name}.${cacheHelperMockResolves.Replace.name}`, () => {
  ...
  test(`${TestValues.ThrowsOnEmpty} cacheName`, () => {
    const actual = () =>
      cacheHelperMockResolves.Replace(
        TestValues.EmptyString,
        TestValues.Key,
        TestValues.Value,
      );
